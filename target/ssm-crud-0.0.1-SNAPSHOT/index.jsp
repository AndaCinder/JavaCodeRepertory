        ...
        <form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      ...
		      <span id="inputSuccess2" class="sr-only"></span>
		    </div>
		  </div>
		  <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
        ...
        <form class="form-horizontal">
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      ...
		      <span  class="help-block"></span>
		      <span id="inputSuccess1" class="sr-only"></span>
		    </div>
		  </div>
		  <div class="form-group">
	...
	<script type="text/javascript">
		...
		function to_page(pn){
			...
			function getDepts(ele){
				...
				$.ajax({
					...
					type:"GET",
					success:function(result){
					//"extend":{"depts":[{"deptId":1,"deptName":"嫖娼部"},{"deptId":2,"deptName":"扫黄部"}]}}
						//console.log(result);
			...
			function validate_add_form(){
				...
				if(!regName.test(empName)){
					...
					show_validate_msg("#empName_add_input", "error", "用户名为2-5位中文或6-16位英文和数字的组合");
			...
			function show_validate_msg(element,status,msg){
				...
				if("success"==status){
					//has-feedback,inputSuccess，(success)
			...
			//1.我们在创建按钮之前绑定了click，所以绑不上
			//1)可以在创建按钮时绑定事件
			//2）绑定点击 live(),jQuery新版本没有live方法，使用on进行替代
		...
		$("#check_all").click(function(){
			//attr获取checked是undefined；使用prop
			//dom原生的属性，attr可以获取自定义属性的值
			//prop修改和读取dom原生属性的值
